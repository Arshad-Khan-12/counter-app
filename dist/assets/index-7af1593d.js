 ...
 */ (function (e) {
  ...
  function E(_, P) {
    ...
    try {
      for (
        d(P), m = t(s);
        m !== null && (!(m.expirationTime > P) || (_ && !xe()));
...
function Vc(e, n, t, r, l, o, u, i, s) {
  (_t = !1), (Rr = null), $c.apply(Ac, arguments);
}
...
var xs = he.unstable_scheduleCallback,
  ...
  Wc = he.unstable_shouldYield,
  Qc = he.unstable_requestPaint,
  W = he.unstable_now,
...
function pt(e, n) {
  e.blockedOn === n &&
    ...
    co ||
      ((co = !0),
      he.unstable_scheduleCallback(he.unstable_NormalPriority, rf)));
}
function Ft(e) {
  function n(l) {
    return pt(l, e);
...
function eu(e, n, t, r) {
  if (Ir) {
    ...
    else if ((Xu(e, r), n & 4 && -1 < nf.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if (
          (o !== null && Ts(o),
...
function Bs(e) {
  if (e.propertyName === "value" && ll(jt)) {
    var n = [];
    As(n, jt, e, Zo(e)), ks(Df, n);
  }
}
function Ff(e, n, t) {
  e === "focusin"
    ? (li(), (xt = n), (jt = t), xt.attachEvent("onpropertychange", Bs))
    : e === "focusout" && li();
}
function jf(e) {
    ...
    if (!(n & 7)) {
      ...
      N &&
        ...
        0 < C.length &&
          ...
          x ? (N.data = x) : ((x = $s(t)), x !== null && (N.data = x)))),
        (x = Tf ? Rf(e, t) : Of(e, t)) &&
...
var it = Math.random().toString(36).slice(2),
  ...
  wo = "__reactEvents$" + it,
  Jf = "__reactListeners$" + it,
  qf = "__reactHandles$" + it;
function Sn(e) {
  var n = e[Ie];
  if (n) return n;
...
function vn() {
  if (!jl && $e !== null) {
    ...
    try {
      ...
      throw ($e !== null && ($e = $e.slice(e + 1)), xs(Jo, vn), l);
    } finally {
      (O = n), (jl = !1);
    }
  }
...
function xa(e, n, t) {
  return Pn & 21
    ? (Oe(t, n) || ((t = zs()), ($.lanes |= t), (zn |= t), (e.baseState = !0)),
      n)
...
function Ti(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null))
    Nr(e, n), ia(n, t, r), xo(n, t, r, l), (r = !0);
  else if (e === null) {
    var u = n.stateNode,
      i = n.memoizedProps;
    u.props = i;
...
function cd(e, n, t, r, l, o, u) {
  ...
  if (((i = (u & e.childLanes) !== 0), ae || i)) {
    ...
    return zu(), (r = Bl(Error(y(421)))), mr(e, n, u, r);
  }
  return l.data === "$?"
    ? ((n.flags |= 128),
      (n.child = e.child),
  ...
  switch ((iu(n), n.tag)) {
    ...
    case 6:
      if (e && n.stateNode != null) Aa(e, n, e.memoizedProps, r);
        ...
        if (((t = En(Ht.current)), En(je.current), dr(n))) {
          if (
            ((r = n.stateNode),
            (t = n.memoizedProps),
            (r[Ie] = n),
...
function Va(e) {
  ...
  n !== null && ((e.alternate = null), Va(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null &&
        (delete n[Ie], delete n[Vt], delete n[wo], delete n[Jf], delete n[qf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Wa(e, n) {
  ...
  switch (e.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      Ne(n, e), Me(e), r & 512 && t !== null && Wn(t, t.return);
      break;
    case 5:
      if (
        (Ne(n, e),
...
function Re(e, n, t, r) {
  ...
  Gt(e, t, r),
    (!(R & 2) || e !== Z) &&
      ...
      de(e, r),
      t === 1 && R === 0 && !(n.mode & 1) && ((lt = W() + 500), il && vn()));
}
function de(e, n) {
  ...
  if (r === 0)
    ...
    if ((t != null && Yu(t), n === 1))
      e.tag === 0 ? bf($i.bind(null, e)) : ea($i.bind(null, e)),
        Gf(function () {
          !(R & 6) && vn();
        }),
        (t = null);
...
function Ka(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    R |= 2;
    var o = Xa();
    (Z !== e || q !== n) && ((Ue = null), (lt = W() + 500), _n(e, n));
    do
      try {
        Sd();
        break;
  ...
  return de(e, W()), e.callbackNode === t ? Ka.bind(null, e) : null;
}
function Uo(e, n) {
  var t = Lt;
  return (
...
function Ed(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    Z === e &&
      (q & t) === t &&
      (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > W() - xu)
        ? _n(e, 0)
        : (Cu |= t)),
    de(e, n);
}
...
qa = function (e, n, t) {
  ...
  else (ae = !1), j && n.flags & 1048576 && na(n, Br, n.index);
...
function Lr(e, n, t, r, l, o) {
  ...
  if (((r = e), typeof e == "function")) Lu(e) && (u = 1);
    ...
    e: switch (e) {
      ...
      case Xl:
        return (
          (e = ke(12, t, n, l | 2)), (e.elementType = Xl), (e.lanes = o), e
        );
      case Gl:
        return (e = ke(13, t, n, l)), (e.elementType = Gl), (e.lanes = o), e;
      case Zl:
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 &&
          (qo(n, t | 1), de(n, W()), !(R & 6) && ((lt = W() + 500), vn()));
      }
      break;
    case 13:
      Ln(function () {
...
ws = Nu;
Ss = Ln;
var Rd = { usingClientEntryPoint: !1, Events: [Jt, $n, ul, ys, gs, Nu] },
  yt = {
...
const Dd = "_container_gnxuq_1",
  Id = "_text_gnxuq_35",
  Fd = "_count_gnxuq_45",
  jd = "_increment_gnxuq_55",
  Ud = "_decrement_gnxuq_85",
  $d = "_reset_gnxuq_115",
  Mn = {
    container: Dd,
    text: Id,
...
function Ad() {
  ...
  return zc("div", {
    ...
    children: [
      Ae("h1", { className: Mn.text, children: "Counter App" }),
      Ae("h2", { className: Mn.count, children: e }),
      Ae("button", {
        className: Mn.increment,
        onClick: t,
        children: "Increment",
      }),
      Ae("button", {
        className: Mn.decrement,
        onClick: r,
        children: "Decrement",
      }),
      Ae("button", { className: Mn.reset, onClick: l, children: "Reset" }),
    ],
  });
}
function Vd() {
  return Ae("div", { className: "App", children: Ae(Ad, {}) });
}
Kl.createRoot(document.getElementById("root")).render(
  Ae(kc.StrictMode, { children: Ae(Vd, {}) })
);
